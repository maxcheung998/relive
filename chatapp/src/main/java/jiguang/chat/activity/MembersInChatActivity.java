                ...
                case R.id.right_btn:
                    if (mIsDeleteMode) {
                        ...
                        if (deleteList.size() > 0) {
                            ...
                            ToastUtil.shortToast(MembersInChatActivity.this, "請最少選擇一位成員");
                        }
                    } else {
                        addMemberToGroup();
                    }
                        ...
                        JMessageClient.removeGroupMembers(mGroupId, list, new BasicCallback() {
                            ...
                            public void gotResult(int status, String desc) {
                                ...
                                if (status == 0) {
                                    ...
                                    Toast.makeText(MembersInChatActivity.this, "刪除失敗" + desc, Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        break;
        ...
        JMessageClient.addGroupMembers(mGroupId, list, new BasicCallback() {
            ...
            public void gotResult(final int status, final String desc) {
                ...
                if (status == 0) {
                    ...
                    Toast.makeText(MembersInChatActivity.this, "添加失敗" + desc, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
