...
public final class CommonScanActivity extends Activity implements ScanListener, View.OnClickListener {
    ...
    public void scanResult(Result rawResult, Bundle bundle) {
        ...
        if (jsonUser.startsWith("http")) {
            ...
            try {
                ...
                Toast.makeText(CommonScanActivity.this, "二維碼錯誤", Toast.LENGTH_SHORT).show();
            }
            ...
            try {
                ...
                final LoadDialog dialog = new LoadDialog(CommonScanActivity.this, false, "正在載入...");
                dialog.show();
    ...
    public void scanError(Exception e) {
        ...
        //相机扫描出错时
        if (e.getMessage() != null && e.getMessage().startsWith("相機")) {
