        ...
        ContactManager.sendInvitationRequest(userName, null, reason, new BasicCallback() {
            ...
            public void gotResult(int responseCode, String responseMessage) {
                ...
                if (responseCode == 0) {
                    ...
                    entry.save();
                    ToastUtil.shortToast(VerificationActivity.this, "申請成功");
                    finish();
                } else if (responseCode == 871317) {
                    ToastUtil.shortToast(VerificationActivity.this, "不能添加自己為好友");
                } else {
                    ToastUtil.shortToast(VerificationActivity.this, "申請失敗");
                }
            }
        });
    }
