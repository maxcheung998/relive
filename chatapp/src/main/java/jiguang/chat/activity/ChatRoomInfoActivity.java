...
public class ChatRoomInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTitle(true, true, "聊天室資料", "", false, "");
        initData();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_exit_room:
                ...
                exitDialog = DialogCreator.createBaseDialogWithTitle(ChatRoomInfoActivity.this, "確定推出聊天室", listener);
                exitDialog.show();
                break;
            default:
                break;
        ...
        ChatRoomManager.leaveChatRoom(roomId, new BasicCallback() {
            ...
            public void gotResult(int i, String s) {
                ...
                if (i == 0) {
                    ...
                    ToastUtil.shortToast(ChatRoomInfoActivity.this, "推出失敗");
                }
            }
        });
    }
    ...
    private void initData() {
        ...
        Dialog loadingDialog = DialogCreator.createLoadingDialog(this, "正在載入...");
        loadingDialog.show();
