...
public class ForwardMsgActivity extends BaseActivity {
    ...
    private void initView() {
        if (getIntent().getFlags() == 1) {
            initTitle(true, true, "發送名片", "", false, "");
        } else {
            initTitle(true, true, "轉發", "", false, "");
        }
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.btn_sure:
                        ...
                        TextContent content = new TextContent("推薦了一張名片");
                        ...
                        textMessage.setOnSendCompleteCallback(new BasicCallback() {
                            ...
                            public void gotResult(int i, String s) {
                                if (i == 0) {
                                    Toast.makeText(ForwardMsgActivity.this, "發送成功", Toast.LENGTH_SHORT).show();
                                } else {
