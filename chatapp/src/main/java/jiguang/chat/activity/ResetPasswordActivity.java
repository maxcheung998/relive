...
public class ResetPasswordActivity extends BaseActivity {
    ...
    private void initView() {
        initTitle(true, true, "修改密碼", "", false, "保存");
                        ...
                        JMessageClient.updateUserPassword(oldPsw, newPsw, new BasicCallback() {
                            ...
                            public void gotResult(int responseCode, String responseMessage) {
                                ...
                                if (responseCode == 0) {
                                    ...
                                    ToastUtil.shortToast(ResetPasswordActivity.this, "修改失敗, 新密碼要在4-128字節之間");
                                }
                            }
                        });
                    } else {
                        ToastUtil.shortToast(ResetPasswordActivity.this, "兩次輸入不相同");
                    }
                } else {
                    ToastUtil.shortToast(ResetPasswordActivity.this, "原密碼不正確");
                }
            }
        });
    }
