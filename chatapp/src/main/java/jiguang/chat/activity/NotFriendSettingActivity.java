    ...
    public void onChanged(int id, boolean checkState) {
        switch (id) {
            case R.id.btn_addBlackList:
                final LoadDialog dialog = new LoadDialog(NotFriendSettingActivity.this, false, "正在設定");
                dialog.show();
                    ...
                    JMessageClient.addUsersToBlacklist(name, new BasicCallback() {
                        ...
                        public void gotResult(int responseCode, String responseMessage) {
                            ...
                            if (responseCode == 0) {
                                ...
                                ToastUtil.shortToast(NotFriendSettingActivity.this, "添加失敗" + responseMessage);
                            }
                        }
                    });
                } else {
                    JMessageClient.delUsersFromBlacklist(name, new BasicCallback() {
                        ...
                        public void gotResult(int responseCode, String responseMessage) {
                            ...
                            if (responseCode == 0) {
                                ...
                                ToastUtil.shortToast(NotFriendSettingActivity.this, "移除失敗" + responseMessage);
                            }
                        }
                    });
                }
