...
public class SetGroupSilenceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dialog loadingDialog = DialogCreator.createLoadingDialog(SetGroupSilenceActivity.this, "正在載入...");
        loadingDialog.show();
            ...
            if (switchButton.isPressed()) {
                mGroupInfo.setGroupMemSilence(mUserName, JMessageClient.getMyInfo().getAppKey(), isChecked, new BasicCallback() {
                    ...
                    public void gotResult(int i, String s) {
                        if (i == 0) {
                            ToastUtil.shortToast(SetGroupSilenceActivity.this, "設定成功");
                        } else {
                            ToastUtil.shortToast(SetGroupSilenceActivity.this, "設定失敗" + i + s);
                        }
                    }
                });
            }
